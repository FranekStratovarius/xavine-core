...
windows-debug:
	...
	xmake
	rsync --recursive --progress --delete --update assets/ ./build/windows/x86_64/debug/assets
...
linux-release:
	...
	xmake
	rsync --recursive --progress --delete --update assets/ ./build/linux/x86_64/release/assets/
