...
windows-debug:
	...
	xmake
	cp -r assets ./build/windows/x86_64/debug/assets

windows-release:
	xmake f -p windows -a x86_64 -m release
	xmake
	cp -r assets ./build/windows/x86_64/release/assets

linux-debug:
	xmake f -p linux -a x86_64 -m debug
	xmake
	cp -r assets ./build/linux/x86_64/debug/assets

linux-release:
	xmake f -p linux -a x86_64 -m release
	xmake
	cp -r assets ./build/linux/x86_64/release/assets
